...
function love.conf(t)
    ...
    t.window.title = "Ultimate pong" -- Заголовок окна (строка)
    t.window.icon = "sprites/UPC.png"                -- Путь к файлу изображения, используемого как значок окна (строка)
    ...
    t.window.resizable = false          -- Разрешаем пользователю изменять размер окна (boolean)
    ...
    t.window.vsync = false              -- Включение вертикальной синхронизации (boolean)
